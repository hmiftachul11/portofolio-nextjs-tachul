...
import ProjectDescription from "@/components/exp-desc";
...
const githubUsername = "hmiftachul11";

export default function Project({ params }: ProjectPageProps) {
    let exp = Projects.find((val) => val.id === params.expId);
    if (!exp) {
        redirect("/projects");
    }
                ...
                <div className="mt-4 flex space-x-4">
                    ...
                    >
                        ...
                        <div className="flex-1 text-left leading-tight">
                            <p className="font-medium">{"Miftachul Huda"}</p>
